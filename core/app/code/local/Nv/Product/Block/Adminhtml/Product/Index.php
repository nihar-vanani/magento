<?php
class Nv_Product_Block_Adminhtml_Product_Index extends Mage_Adminhtml_Block_Widget_Grid_Container{
	...
	public function __construct()
	{
		...
		parent::__construct();
 		//$this->setTemplate('product/adminhtml/product/index.phtml');
	}
}