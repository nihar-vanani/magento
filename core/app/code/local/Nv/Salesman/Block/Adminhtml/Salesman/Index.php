<?php
class Nv_Salesman_Block_Adminhtml_Salesman_Index extends Mage_Adminhtml_Block_Widget_Grid_Container{
	...
	public function __construct()
	{
		...
		parent::__construct();
 		//$this->setTemplate('salesman/adminhtml/salesman/index.phtml');
	}
}