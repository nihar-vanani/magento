<?php
class Nv_Category_Block_Adminhtml_Category_Index extends Mage_Adminhtml_Block_Widget_Grid_Container{
	...
	public function __construct()
	{
		...
		parent::__construct();
 		//$this->setTemplate('category/adminhtml/category/index.phtml');
	}
}